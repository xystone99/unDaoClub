...
public abstract class AbstractMailSite {
	...
	public abstract String sendSMS( String targetMobile, String content );
	...
	public AbstractMailSite(String userName, String userPwd) {
		super();
		user_name = userName;
		user_pwd = userPwd;
