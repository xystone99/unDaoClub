...
public class EnumConstants {
	...
	//运输计划类别
	public static final String TRANS_PLAN_K_OPTIONS = "<option value=\"单程提货\">单程提货</option><option value=\"返空提货\">返空提货</option><option value=\"单程送货\">单程送货</option><option value=\"直提直送\">直提直送</option><option value=\"往返运输\">往返运输</option><option value=\"其它运输\">其它运输</option>";
