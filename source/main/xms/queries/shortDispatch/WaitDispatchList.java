...
public class WaitDispatchList extends AbstractQuery {

	private final static int DEFAULT_PAGE_SIZE = 20;
	private final static String QUERY_SQL = "SELECT SQL_CALC_FOUND_ROWS trans_p,plan_k,plan_date,obj_short,time_level,ne_recycle,ne_zh1,window_1,remark_1,ne_zh2,window_2,remark_2,qty_w,qty_v,qty_meter,qty_meter_r,route_zh,dispatch_remark,user_zh,input_date FROM view_trans_plan_list ";
	...
	public final static String QP_DATE = "fPlanDate";						//发货日期
	public final static String QP_ROUTE_ZH = "fRouteZh";					//调度路径
	...
	private final static String[] arr_param_serial = {
			QP_SORT_TAG, QP_IF_HIDE, QP_PLAN_K, QP_OBJECT_P, QP_DATE, QP_LOAD_NAME, QP_USER_ZH, QP_ROUTE_ZH
	};
	...
	public void setDefaultParameterValue( ) {
		...
		parameterMap.put( QP_DATE, DateUtils.formatDateStepDays(1) );
		parameterMap.put( QP_LOAD_NAME, SQL_EMPTY );
		parameterMap.put( QP_USER_ZH, SQL_EMPTY );
		parameterMap.put( QP_ROUTE_ZH, SQL_EMPTY );
